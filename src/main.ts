...
const upgrade1 = new Upgrade("Buy Stock", 10, .1)
const upgrade2 = new Upgrade("Post on Reddit about poor financial choices", 100, 2)
const upgrade3 = new Upgrade("Withdraw your kids' college funds to invest", 1000, 50)
